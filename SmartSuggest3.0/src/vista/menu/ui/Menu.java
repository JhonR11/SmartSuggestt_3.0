...
import vista.menuCambioDeNacionalidad.LightDarkMode;
...
import vista.menuCambioDeNacionalidad.ToolBarAccentColor;
...
/////Los items, en el video de donde saque esto lo explica el man, por cierto qeu video tan gore
    private final String menuItems[][] = {
        {"~Menu Pincipal~"},
        {"Catalogo de Graficas"},
        {"~Herramientas~"},
        {"Utilidades", "Catalogo de Tarjetas ", "Sugerencia ", "easteregg"},
        {"Cerrar Usuario"}
    };
    ...
    private final String headerName = "Smart Suggest";
